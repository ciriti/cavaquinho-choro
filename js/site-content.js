window.CavaquinhoSiteContent = {
  index: {
    en: {
      metaTitle: 'Brazilian Cavaquinho — Choose Your Path',
      heroHtml: `
        <span class="eyebrow">Study Paths</span>
        <h1>Brazilian cavaquinho, two musical roads to choose from</h1>
        <p>The site now opens like a guided studio. You can enter the world of <strong>Choro</strong>, built on precision, anticipation and roda language, or the world of <strong>Forró</strong>, built on groove patterns, singable harmony and repertoire close to bands like Falamansa.</p>
      `,
      mainHtml: `
        <section class="chooser" aria-label="Choose your musical path">
          <article class="genre-card choro">
            ...
            <h2>Choro</h2>
            <p>The original learning path: module after module, from right hand technique to progressions in C, G, F, A minor and D minor, with cadences, trio sections, repertoire and chord shapes.</p>
            <ul class="card-points">
              <li>Garfinho, harmonic anticipation and 2/4 accompaniment.</li>
              <li>Classic choro progressions: ii–V–I, dominant chains, trio sections and modulations.</li>
              <li>Chord shapes, inversions and repertoire to study with method.</li>
            </ul>
          ...
          <article class="genre-card forro">
            ...
            <h2>Forró</h2>
            <p>A new section built with the same teaching spirit as the Choro site, but shaped like a forró tutor: groove patterns, xote, baião, falling minor cadences, common keys and the harmonic loops that show up again and again in popular repertoire.</p>
            <ul class="card-points">
              <li>Xote and baião patterns explained through rhythm and daily practice.</li>
              <li>Harmonic families and loops that keep returning in repertoire close to Falamansa.</li>
              <li>Visual chord shapes, hover diagrams and practical accompaniment frameworks.</li>
            </ul>
            <div class="card-actions">
        ...
        <section class="overview" aria-label="Overview of the two paths">
          <article class="panel">
            <h3>How to choose</h3>
            <p>If you want to build a precise right hand and detailed accompaniment, begin with Choro. If you want to jump quickly into danceable popular repertoire, the Forró path is the most direct starting point.</p>
            <table class="compare-table">
              ...
              <tbody>
                <tr>
                  <td><strong>Choro</strong></td>
                  <td>Rhythmic precision, anticipation, modulation and roda repertoire.</td>
                  <td>More control, better harmonic reading and stronger refined accompaniment.</td>
                </tr>
                <tr>
                  <td><strong>Forró</strong></td>
                  <td>Groove, singable harmonic cycles, pushing dominants and stage-friendly keys.</td>
                  <td>Confident xote and baião accompaniment with a useful vocabulary from day one.</td>
                </tr>
              </tbody>
            </table>
          </article>
          ...
          <aside class="panel">
            ...
            <ul class="panel-list">
              <li>
                <strong>If you want complete cavaquinho training</strong>
                Enter Choro and build right hand discipline, early changes and cadence logic.
              </li>
              <li>
                <strong>If you want to accompany songs immediately</strong>
                Enter Forró and work on the most recognizable xote and baião loops.
              </li>
              <li>
                <strong>If you want both worlds</strong>
                Use Choro for hand discipline and Forró for direct repertoire application.
              </li>
            </ul>
          </aside>
        </section>
      `,
      footer: 'Choose a path, enter the dedicated page and study by musical families rather than isolated sheets.'
    },
    pt: {
      metaTitle: 'Cavaquinho Brasileiro — Escolha o Caminho',
      heroHtml: `
        <span class="eyebrow">Percursos de Estudo</span>
        <h1>Cavaquinho brasileiro, dois caminhos musicais para escolher</h1>
        <p>O site agora abre como um pequeno estúdio guiado. Você pode entrar no universo do <strong>Choro</strong>, com precisão, antecipação e linguagem de roda, ou no universo do <strong>Forró</strong>, com levadas, harmonia cantável e repertório próximo de grupos como Falamansa.</p>
      `,
      mainHtml: `
        <section class="chooser" aria-label="Escolha seu caminho musical">
          <article class="genre-card choro">
            ...
            <h2>Choro</h2>
            <p>O percurso original: módulo por módulo, da mão direita até os giros em Dó, Sol, Fá, Lá menor e Ré menor, com cadências, trio, repertório e desenhos de acordes.</p>
            <ul class="card-points">
              <li>Garfinho, antecipação harmônica e acompanhamento em 2/4.</li>
              <li>Progressões clássicas do choro: ii–V–I, cadeia de dominantes, trio e modulações.</li>
              <li>Diteggiaturas, inversões e repertório para estudar com método.</li>
            </ul>
            <div class="card-actions">
          ...
          <article class="genre-card forro">
            ...
            <h2>Forró</h2>
            <p>Uma nova seção construída com o mesmo espírito didático do site de Choro, mas pensada como um tutor de forró: levada, xote, baião, cadências menores, tonalidades recorrentes e giros muito usados no repertório popular.</p>
            <ul class="card-points">
              <li>Levada de xote e baião explicada pela função rítmica e pela prática diária.</li>
              <li>Famílias harmônicas e giros que aparecem o tempo todo em repertório no estilo Falamansa.</li>
              <li>Diteggiaturas visuais, diagramas em hover e esquemas prontos para acompanhar.</li>
            </ul>
            <div class="card-actions">
        ...
        <section class="overview" aria-label="Visão geral dos dois percursos">
          <article class="panel">
            <h3>Como se orientar</h3>
            <p>Se você quer construir uma mão direita precisa e um acompanhamento detalhado, comece pelo Choro. Se quer entrar rapidamente no repertório dançante e cantável, o percurso de Forró é o começo mais direto.</p>
            <table class="compare-table">
              <thead>
                <tr>
                  <th>Percurso</th>
              ...
              <tbody>
                <tr>
                  <td><strong>Choro</strong></td>
                  <td>Precisão rítmica, antecipação, modulação e repertório de roda.</td>
                  <td>Mais controle, melhor leitura harmônica e acompanhamento refinado mais sólido.</td>
                </tr>
                <tr>
                  <td><strong>Forró</strong></td>
                  <td>Levada, ciclos harmônicos cantáveis, dominantes que empurram e tonalidades de palco.</td>
                  <td>Acompanhar xote e baião com segurança e vocabulário útil desde o começo.</td>
                </tr>
              </tbody>
            </table>
          </article>
          ...
          <aside class="panel">
            <h3>Por onde começar hoje</h3>
            <ul class="panel-list">
              <li>
                <strong>Se você quer uma formação completa no cavaco</strong>
                Entre em Choro e construa disciplina de mão direita, trocas antecipadas e lógica de cadências.
              </li>
              <li>
                <strong>Se você quer acompanhar canções imediatamente</strong>
                Entre em Forró e trabalhe os giros mais reconhecíveis do xote e do baião.
              </li>
              <li>
                <strong>Se você quer os dois mundos</strong>
                Use Choro para a disciplina da mão e Forró para a aplicação direta no repertório.
              </li>
            </ul>
          </aside>
        </section>
      `,
      footer: 'Escolha um percurso, entre na página dedicada e estude por famílias musicais, não por cifras isoladas.'
    }
  },
  forro: {
    en: {
      metaTitle: 'Cavaquinho & Forró — Learning System',
      title: 'Cavaquinho & Forró',
...
| A   | E   | A   | G#  |</pre>
    ...
    pt: {
      metaTitle: 'Cavaquinho & Forró — Sistema de Aprendizado',
      title: 'Cavaquinho & Forró',
...
| A   | E   | A   | G#  |</pre>
  ...
  choro: {
    en: {
      metaTitle: 'Cavaquinho & Choro — Learning System',
      title: 'Cavaquinho & Choro',
...
Trio: | C | G7 | C | F | G7 | C |</pre>
    ...
    pt: {
      metaTitle: 'Cavaquinho & Choro — Sistema de Aprendizado',
      title: 'Cavaquinho & Choro',
